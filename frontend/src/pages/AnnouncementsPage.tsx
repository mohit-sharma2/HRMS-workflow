              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-50 bg-white">
                  ...
                  {ann.category === 'Policy' && (
                    <button
                      onClick={() => {
                        if (!acknowledged.includes(ann.id)) {
                          setAcknowledged([...acknowledged, ann.id]);
                        }
                      }}
                      disabled={acknowledged.includes(ann.id)}
                      className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg transition-colors font-medium border
                        ${acknowledged.includes(ann.id)
                    ...
                    >
                      ...
                      {acknowledged.includes(ann.id) ? 'Acknowledged' : 'Acknowledge Policy'}
                    </button>
                  )}
                </div>
              </div>
